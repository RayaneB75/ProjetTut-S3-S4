...
command -v openssl >/dev/null 2>&1 || { 
	echo >&2 "Impossible de trouver openssl."; exit 1; 
}
...
-subj "/C=VN/ST=SAIGON/L=SAIGON/O=OpenVPN-TEST/emailAddress=admin@health-sprint.fr" \
-config openssl.cnf
...
-subj "/C=VN/ST=SAIGON/O=OpenVPN-TEST/CN=VPN-Server/emailAddress=admin@health-sprint.fr"
